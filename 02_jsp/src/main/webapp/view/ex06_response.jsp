...
<%-- 
 ...
 --%>
 <p><a href="ex02_script.jsp">이동하기(파라미터 없음)</a></p>
 <p><a href="ex05_result.jsp?name=둘리&age=24&gender=남&hobby=운동&hobby=게임">이동하기(파라미터 있음)</a></p>
 <hr>
...
<% response.sendRedirect("ex05_result.jsp?name=gkgk&age=31&gender=women&hobby=chch&hobby=rprp"); %>
