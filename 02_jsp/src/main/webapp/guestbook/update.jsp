		...
		<form method="post">
			<table>
				<tr align="center">
					...
					<td><input type="text" name="name" size ="20" value="${vo.name}" /></td>  <!-- input name과 vo name이 일치해야함 -->
				</tr>
				<tr align="center">
				...
				<tfoot>
					<tr align="center">
						<td colspan="2">
							...
							<input type="hidden" value="${vo.idx}" name="idx">  <!-- db정보를 확인해서 수정하기 위해 필요한 정보 -->
